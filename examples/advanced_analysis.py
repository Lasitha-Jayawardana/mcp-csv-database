...
def create_realistic_dataset():
    ...
    customers_data = pd.DataFrame({
        ...
        "age": (
            np.random.randint(18, 80, 100).tolist() +
            [None, 25, None]  # Some missing ages
        ),
        "city": (
            np.random.choice(["New York", "Los Angeles", "Chicago", "Houston", "Phoenix"], 100).tolist() +
    ...
    sales_data = pd.DataFrame({
        ...
        "product": np.random.choice([
            "Laptop", "Phone", "Tablet", "Headphones", "Watch", "Camera"
        ], 200),
        ...
        "sales_rep": np.random.choice([
            "John Doe", "Jane Smith", "Mike Johnson", None, ""
        ], 200)  # Some missing sales reps
    })
    
    # Create product catalog
    product_data = pd.DataFrame({
        "product_name": ["Laptop", "Phone", "Tablet", "Headphones", "Watch", "Camera"],
        "category": ["Computers", "Electronics", "Computers", "Accessories", "Accessories", "Electronics"],
